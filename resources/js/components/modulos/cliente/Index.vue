                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" v-model="fillBusquedaCliente.cNombre" @keyup.enter="getListarClientes">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" v-model="fillBusquedaCliente.cDocumento" @keyup.enter="getListarClientes">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
export default {
    ...
    methods: {
        limpiarCriteriosBusqueda() {
            this.fillBusquedaCliente.cNombre     =  '';
            this.fillBusquedaCliente.cDocumento  =  '';
        },
        ...
        getListarClientes()
        {
            ...
            axios.get(url, {
                params: {
                    'cNombre'       :   this.fillBusquedaCliente.cNombre,
                    'cDocumento'    :   this.fillBusquedaCliente.cDocumento
                }
            }).then( response => {
