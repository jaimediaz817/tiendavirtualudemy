<template>
    <div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" v-model="fillBusquedaRol.cNombre" @keyup.enter="getListarRoles">
                                                </div>
                                            </div>
                                        </div>
        ...
        <!-- Modal -->
        <div class="modal fade " :class="{ show: modalShow }" :style=" modalShow ? mostrarModal : ocultarModal" style="overflow-y: scroll;">
